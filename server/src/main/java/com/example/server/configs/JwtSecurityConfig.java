...
import com.example.server.filters.CustomAccessDeniedHandler;
import com.example.server.filters.JwtAuthenticationTokenFilter;
import com.example.server.filters.RestAuthenticationEntryPoint;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.antMatcher("/api/**").httpBasic().authenticationEntryPoint(restServicesEntryPoint()).and()
                ...
                .antMatchers(HttpMethod.GET, "/api/**").access("isAuthenticated() and hasAnyRole('ROLE_ADMIN', 'ROLE_ALUMNI', 'ROLE_LECTURER')")
                ...
                .antMatchers( "/api/groups/**").access("hasAnyRole('ROLE_ADMIN')")
                .antMatchers( "/api/letters/**").access("hasAnyRole('ROLE_ADMIN')")
                .antMatchers( "/api/stats/**").access("hasAnyRole('ROLE_ADMIN')")
