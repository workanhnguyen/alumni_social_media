...
<div class="container-fluid">
    ...
    <form:form method="post" action="${addNewUser}" modelAttribute="user" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3 mt-3">
            ...
            <c:if test="${isUsernameExisting == true}">
                <div id="username-flag" class="text-danger">Ten dang nhap da ton tai</div>
            </c:if>
        </div>
        <div class="form-floating mb-3 mt-3">
        ...
        <div class="form-floating mb-3 mt-3">
            <form:input type="file" class="form-control"
                        path="avatarFile" id="avatar-file"/>
        ...
        <div class="form-floating mb-3 mt-3">
            <form:input type="file" class="form-control"
                        path="bgImageFile" id="bg-image-file"/>
            <label for="bg-image-file">Ảnh bìa</label>
        ...
        <button type="submit" class="w-100 btn btn-success mt-3" onclick="sendEmail()">Thêm mới</button>
    </form:form>
</div>
