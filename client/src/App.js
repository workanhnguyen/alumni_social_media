...
import { AlumniAddInfo, AlumniLoginPage, AlumniRegisterPage, ChooseRolePage, DashBoard, GroupPage, LecturerLoginPage, LetterPage, PersonalPage } from './pages';
import PostDetailPage from './pages/PostDetailPage';
import { ALUMNI_ADD_INFO, ALUMNI_LOGIN, ALUMNI_REGISTER, CURRENT_USER, DASHBOARD, GROUPS, LECTURER_LOGIN, LETTERS, POST_DETAIL, ROOT_PAGE } from './routes';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path={ALUMNI_ADD_INFO} element={<AlumniAddInfo />} />
